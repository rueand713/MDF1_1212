...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    // changed the UIViewControllers to First and Second views so that I can use a delegate to communicate between them
    ...
    // sets the mapDelegate to be accessible through the firstView
    viewController2.mapDelegate = viewController1;
